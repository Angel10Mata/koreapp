...
export function RoleSimulator() {
  ...
  return (
    <div className="fixed top-1/2 -translate-y-1/2 right-0 z-[9999] flex items-center group">
      <div className="bg-white/80 dark:bg-background/80 backdrop-blur-md border border-r-0 border-white/20 rounded-l-xl px-2 py-1.5 flex flex-col gap-1 transition-transform duration-500 translate-x-full group-hover:translate-x-0 cursor-pointer">
      ...
      <div className="bg-white/80 dark:bg-background/80 backdrop-blur-md px-1 py-1.5 rounded-l-lg border border-r-0 border-white/20 cursor-pointer transition-opacity duration-300 group-hover:opacity-0 group-hover:pointer-events-none">
