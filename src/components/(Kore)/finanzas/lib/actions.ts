...
export async function obtenerGastos() {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error desconocido al obtener gastos";
    return { data: null, error: msg };
  }
}
...
export async function crearGasto(formData: GastoFormValues) {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error interno al crear gasto";
    return { error: msg };
  }
}
...
export async function crearIngreso(formData: IngresoFormValues) {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error interno al crear ingreso";
    return { error: msg };
  }
}
...
export async function actualizarGasto(id: string, formData: GastoFormValues) {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error interno al actualizar gasto";
    return { error: msg };
  }
}
...
export async function anularGasto(id: string) {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error interno al anular gasto";
    return { error: msg };
  }
}
...
export async function anularIngreso(id: string) {
  ...
  try {
    ...
    const msg = error instanceof Error ? error.message : "Error interno al anular ingreso";
    return { error: msg };
  }
}
